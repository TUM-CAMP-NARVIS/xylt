...
struct IntrinsicParameters {
    ...
    IntrinsicParameters(float _fov_x, float _fov_y, float _c_x, float _c_y, unsigned int _width, unsigned int _height,
        ...
        : fov_x(_fov_x), fov_y(_fov_y)
          , c_x(_c_x), c_y(_c_y)
          , width(_width), height(_height)
          , radial_distortion(std::move(_radial_distortion))
          , tangential_distortion(std::move(_tangential_distortion)) { }

    IntrinsicParameters(const IntrinsicParameters& other)
        : fov_x(other.fov_x), fov_y(other.fov_y)
